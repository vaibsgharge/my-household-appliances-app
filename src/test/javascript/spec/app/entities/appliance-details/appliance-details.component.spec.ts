...
import { ApplianceDetailsComponent } from 'app/entities/appliance-details/appliance-details.component';
...
describe('Component Tests', () => {
  describe('ApplianceDetails Management Component', () => {
    let comp: ApplianceDetailsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ApplianceDetailsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.applianceDetails && comp.applianceDetails[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
