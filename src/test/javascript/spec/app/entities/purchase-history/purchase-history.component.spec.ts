...
import { PurchaseHistoryComponent } from 'app/entities/purchase-history/purchase-history.component';
...
describe('Component Tests', () => {
  describe('PurchaseHistory Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.purchaseHistories && comp.purchaseHistories[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
