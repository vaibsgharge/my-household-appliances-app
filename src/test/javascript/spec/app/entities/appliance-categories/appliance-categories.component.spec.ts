...
import { ApplianceCategoriesComponent } from 'app/entities/appliance-categories/appliance-categories.component';
...
describe('Component Tests', () => {
  describe('ApplianceCategories Management Component', () => {
    let comp: ApplianceCategoriesComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ApplianceCategoriesComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new ApplianceCategories(123)],
            headers
          })
        )
      );
      ...
      expect(comp.applianceCategories && comp.applianceCategories[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
